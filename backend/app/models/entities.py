...
class GameStarter(Base):
    ...
    prior_hit_batters: Mapped[int] = mapped_column(Integer, default=0)
    prior_batters_faced: Mapped[int] = mapped_column(Integer, default=0)
    ...
    metric_schema_version: Mapped[int] = mapped_column(Integer, default=2)
    source: Mapped[str] = mapped_column(String(80))
    source_url: Mapped[str] = mapped_column(Text)
    collected_at: Mapped[datetime] = mapped_column(DateTime(timezone=True))
