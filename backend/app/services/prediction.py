...
SIMULATION_SUMMARY_SCHEMA_VERSION = 15
...
def build_score_estimates(top_scores: list[dict[str, Any]], primary_score: dict[str, Any],
    ...
    - representative: the full-population integer projection, constrained by the same simulated
      winner and -1.5 cover majority used by the market probabilities.
    """
