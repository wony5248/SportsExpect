...
SIMULATION_SUMMARY_SCHEMA_VERSION = 16
...
def predict_game(game: Any, home: Any, away: Any, home_pitcher: Any | None, away_pitcher: Any | None,
    ...
    input_data = {
        ...
        # The market total never changes the score distribution. It is persisted only so the
        # integer headline scenario can agree with the over/under probability shown beside it.
        "headline_market": {"total_line": headline_market.get("total_line")},
