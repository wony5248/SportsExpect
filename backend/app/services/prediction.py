...
# 23: archived starters give past games real pre-game pitching inputs, so every replay produced
# before them was built from a blank starter and has to be regenerated.
SIMULATION_SUMMARY_SCHEMA_VERSION = 23
