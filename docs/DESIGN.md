...
7. 2026-08-23 KBO 경기부터 경기 전 기준 기대득점과 실제 득점의 팀별 공격·수비 잔차를 12경기 반감기 EWMA로 계산한다. 홈·원정 잔차는 별도로 축소해 10%만 혼합하고, 맞대결 잔차는 40경기 사전표본으로 강하게 축소한 뒤 10%만 반영한다. 기존 모델이 최근 기세를 이미 반영하므로 550경기 walk-forward에서 전 지표를 개선한 평균회귀 계수(-0.50)를 사용해 같은 흐름의 중복 반영을 막는다.
